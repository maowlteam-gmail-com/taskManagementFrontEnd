...
class TaskUpdateScreen extends StatelessWidget {
  ...
  Widget _buildTaskHeader(
    String taskName,
    String today,
    TaskUpdateController controller,
  ) {
    return Container(
    ...
    return Column(
      ...
      children: [
                  ...
                  controller.getFileName() != null
                      ? Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              controller.getTruncatedFileName(
        ...
        Obx(
          () =>
              !controller.isFileValid.value &&
                      controller.fileErrorMessage.value.isNotEmpty
                  ? Padding(
  ...
  Widget _buildCollaboratorsSection(TaskUpdateController controller) {
    return Column(
      ...
      children: [
        ...
        Obx(
          () =>
              controller.selectedCollaborators.isEmpty
                  ? Container(
                    width: double.infinity,
                    padding: EdgeInsets.all(16.sp),
                    decoration: BoxDecoration(
                  ...
                  : Wrap(
                    ...
                    runSpacing: 8.h,
                    children:
                        controller.selectedCollaborators.map((collaborator) {
                          return Chip(
                            label: Text(
  ...
  Widget _getFileTypeIcon(String fileName) {
    ...
    return Icon(iconData, size: 24.sp, color: iconColor);
  }
}
