...
import 'package:maowl/screens/employeeScreen/controller/employeeHistoryController.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Obx(() => Text(
          '${controller.currentEmployeeName.value} History',
          style: TextStyle(
            color: Colors.black,
            fontSize: 18.sp,
      ...
      body: Obx(() {
        ...
        return RefreshIndicator(
          onRefresh: () => controller.fetchOwnHistory(),
          child: Column(
            children: [
              // Header with count
              Container(
